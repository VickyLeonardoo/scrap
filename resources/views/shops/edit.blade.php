<x-app-layout>
    <div class="py-12 bg-gradient-to-br from-red-50 to-white min-h-screen">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 class="text-3xl font-bold text-gray-800 mb-6">Edit Toko</h1>
                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('shops.update', $shop) }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="link" class="block mt-1 w-full rounded-md border-gray-300 focus:border-red-300 focus:ring focus:ring-red-200 focus:ring-opacity-50" type="url" name="link" :value="old('link', $shop->link)" required autofocus />
