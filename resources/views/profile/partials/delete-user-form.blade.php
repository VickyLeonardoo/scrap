        ...
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6">
            ...
            <div class="mt-6">
                ...
                <x-text-input
                    ...
                    name="password"
                    type="password"
                    class="mt-1 block w-3/4 rounded-md border-gray-300 shadow-sm focus:border-red-300 focus:ring focus:ring-red-200 focus:ring-opacity-50"
            ...
            <div class="mt-6 flex justify-end">
                ...
                <x-danger-button class="bg-red-600 hover:bg-red-700 focus:bg-red-700 active:bg-red-800">
                    {{ __('Hapus Akun') }}
                </x-danger-button>
            </div>
        </form>
